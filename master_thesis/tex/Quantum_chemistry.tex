...
The energy of the system can be calculated as follows, assuming that the wavefunction
\red{XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX}
$\Psi$ \cite{Cramer:2004}:
