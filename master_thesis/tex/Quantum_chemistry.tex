...
An important point ot note is that at the start of this section we assummed our
wavefunction to consist of a single determinant. This is part of the Hartree-Fock
approximation, where we only care about the lowst energy level of the system, and
